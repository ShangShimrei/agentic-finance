...
var FinancialElement = class extends Element {
  height() {
...
var OhlcElement = class extends FinancialElement {
  draw(ctx) {
    ...
    if (close < open) {
      ctx.strokeStyle = valueOrDefault(me.color ? me.color.up : void 0, globalOpts$1.elements.ohlc.color.up);
    } else if (close > open) {
      ctx.strokeStyle = valueOrDefault(me.color ? me.color.down : void 0, globalOpts$1.elements.ohlc.color.down);
    } else {
      ctx.strokeStyle = valueOrDefault(me.color ? me.color.unchanged : void 0, globalOpts$1.elements.ohlc.color.unchanged);
    }
  ...
  scales: {
    x: {
      ...
      ticks: {
        ...
        fontStyle: (context) => context.tick.major ? "bold" : void 0,
        source: "data",
        maxRotation: 0,
        autoSkip: true,
        autoSkipPadding: 75,
...
var CandlestickElement = class extends FinancialElement {
  draw(ctx) {
    ...
    let borderColor;
    if (close < open) {
      borderColor = valueOrDefault(borderColors ? borderColors.up : void 0, globalOpts.elements.candlestick.borderColor);
      ctx.fillStyle = valueOrDefault(me.color ? me.color.up : void 0, globalOpts.elements.candlestick.color.up);
    } else if (close > open) {
      borderColor = valueOrDefault(borderColors ? borderColors.down : void 0, globalOpts.elements.candlestick.borderColor);
      ctx.fillStyle = valueOrDefault(me.color ? me.color.down : void 0, globalOpts.elements.candlestick.color.down);
    } else {
      borderColor = valueOrDefault(borderColors ? borderColors.unchanged : void 0, globalOpts.elements.candlestick.borderColor);
      ctx.fillStyle = valueOrDefault(me.color ? me.color.unchanged : void 0, globalOpts.elements.candlestick.color.unchanged);
    }
